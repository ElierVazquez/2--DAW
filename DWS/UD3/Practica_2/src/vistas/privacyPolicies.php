...
<body>
    ...
    <h2 class="policies">PRIVACY POLICY</h2>
        ...
        <p>Our website uses the information in order to provide the best possible service, particularly to maintain a record of users, orders if applicable, and improve our products and services. Emails may be sent periodically through our site with special offers, new products and other advertising information that we consider relevant to you or that may provide you with some benefit, these emails will be sent to the address you provide and may be unsubscribed. . whenever.</p>
        <p>Chess está altamente comprometido para cumplir con el compromiso de mantener su información segura. Usamos los sistemas más avanzados y los actualizamos constantemente para asegurarnos que no existe ningún acceso no autorizado.</p>
        <h3>Cookies</h3>
        ...
        <p>At any time you may restrict the collection or use of personal information that is provided to our website. Each time you are asked to fill out a form, such as the user registration form, you can check or uncheck the option to receive information by email. If you have selected the option to receive our newsletter or advertising, you can cancel it at any time.</p>
        ...
        <p>Chess reserves the right to change the terms of this Privacy Policy at any time.</p>
    </div>
    <footer>
